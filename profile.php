...
if($uinfo==false){
  ...
  $engagement_overall = $user->get_awards('overall', 'engagement');
    ...
    if (!empty($esteem_overall)) $template->pageData['content'] .= displayUserAwards($esteem_overall);
    ...
    if (!empty($esteem_la)) $template->pageData['content'] .= displayUserAwards($esteem_la);
    ...
    if (!empty($esteem_va)) $template->pageData['content'] .= displayUserAwards($esteem_va);
    ...
    if (!empty($esteem_sa)) $template->pageData['content'] .= displayUserAwards($esteem_sa);
    ...
    if (!empty($esteem_ca)) $template->pageData['content'] .= displayUserAwards($esteem_ca);
    ...
    if (!empty($esteem_fa)) $template->pageData['content'] .= displayUserAwards($esteem_fa);
    ...
    if (!empty($engagement_overall)) $template->pageData['content'] .= displayUserAwards($engagement_overall);
    ...
    if (!empty($engagement_la)) $template->pageData['content'] .= displayUserAwards($engagement_la);
    ...
    if (!empty($engagement_va)) $template->pageData['content'] .= displayUserAwards($engagement_va);
    ...
    if (!empty($engagement_sa)) $template->pageData['content'] .= displayUserAwards($engagement_sa);
    ...
    if (!empty($engagement_ca)) $template->pageData['content'] .= displayUserAwards($engagement_ca);
    ...
    if (!empty($engagement_fa)) $template->pageData['content'] .= displayUserAwards($engagement_fa);
	...
	{
		$template->pageData['content'] .= ' <div class="col-xs-12">
												<br/>
												There are no Teaching Tips posted by this user.
											</div>
											';
	}
	...
	if(sizeof($ttsSorted)>3){
		$template->pageData['content'].="
			<div class='col-xs-12 profile-view-more' data-user-id='{$usrID}'>
             ...
             <div class='col-xs-12 profile-view-more-tts-wrapper'>
